...
import static oop.collection.domain.Visibility.*;
...
// ── 1. 활동 목록 구성 ─────────────────────────────────────────
        ...
        LearningActivity lecture1 = new LectureLog("Java 컬렉션 프레임워크 이론", 50, PUBLIC, "박코치");
        LearningActivity lecture2 = new LectureLog("Java 내부 클래스 활용", 50, PUBLIC, "김코치");
        LearningActivity practice1 = new PracticeLog("ArrayList 실습", 80, PUBLIC, 90);
        LearningActivity reading = new ReadingLog("Effective Java 3판", 35, PRIVATE, "조슈아 블로크");
        LearningActivity practice2 = new PracticeLog("LinkedList 비교 실습", 40, PRIVATE, 75);
        LearningActivity practice3 = new PracticeLog("HashMap 비교 실습", 30, PRIVATE, 95);
        ...
        lecture1.addTag("JCF");  // 이미 있으면 무시됨
        System.out.println("lecture 태그: " + lecture1.getTags());
